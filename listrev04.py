...
def main():
    ## create a list alraedy containing IP addresses (strings)
    ...
    ## append takes whatever it is passed and adds it to the list object
    ...
    ## just list extend, append expects exactly one item to be passed.
